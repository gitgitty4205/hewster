    ...
    <main className="min-h-screen bg-[var(--hewie-bg)] text-zinc-900">
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center px-6 py-12 text-center">
        <div className="w-full rounded-[2rem] bg-white/90 p-8 shadow-sm ring-1 ring-zinc-200">
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-[var(--hewie-active-text)]"><PetNotebookTitle /></p>
          <h1 className="mt-3 text-xl font-bold tracking-tight text-[#3b2832]">Coming Soon</h1>
