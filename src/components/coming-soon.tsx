    ...
    <main className="min-h-screen bg-[#979ca7] text-zinc-900">
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center px-6 py-12 text-center">
        <div className="w-full rounded-[2rem] bg-white/90 p-8 shadow-sm ring-1 ring-zinc-200">
          <p className="text-sm font-medium uppercase tracking-[0.2em] text-violet-500">Pet Notebook</p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-zinc-900">Coming Soon</h1>
          <p className="mt-4 text-sm leading-6 text-zinc-600">
            Pet Notebook is getting ready. A polished pet care tracker is on the way.
          </p>
        </div>
      </div>
    </main>
